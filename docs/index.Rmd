...
today <- Sys.Date()
# Load shapefile
geoData <- sf::read_sf(here::here("data", "shapefile"))
# Load case data
...
geoData <- dplyr::left_join(geoData, cases, by = c("GAUL_CODE" = "code"))
# Load estimates
